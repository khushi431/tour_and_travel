...
<?php
 ...
 if(isset($_POST['click']))
 {
  ...
  $insert_query = "insert into cab_table(taxi_type,taxi_model,rent_for_a_day,no_of_seats,image) values ('$taxi_for_day','$taxi_for','$from_location','$destination','$file_name')";
  if($insert_query)
...
<h1 class="display-6 text-center w-100">Taxi Details</h1>
    
      
   
   <section class="container my-2  w-100 text-light p-2 ">
   <!-- bg-dark -->
