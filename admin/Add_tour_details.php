...
<?php
 ...
 if(isset($_POST['click']))
 {
  ...
  $insert_query = "insert into tour_details(tour_id,day,day_detail) values ('$taxi_for_day','$taxi_for','$from_location')";
  if($insert_query)
  ...
  if($result) 
  {  
    echo "<script>alert ('Tour Details Added Successfully')
    </script>";
  }
